...
<template>
    <nav id="admin-sidebar" class=" col-md-3 col-lg-2 p-0 position-relative sidebar text-white bg-primary">
        ...
        <ul class="nav flex-column fs-5 fw-bold">
            <li class="nav-item">
                <RouterLink class="nav-link d-flex" to="/a">
            ...
            <li class="nav-item">
                <RouterLink class="nav-link d-flex" to="/records">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-book"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>
                    <span class="ps-2">Records</span>
                </RouterLink>
            </li>
            <li class="nav-item">
                <RouterLink class="nav-link d-flex" to="/reports">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bar-chart-2"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>
                    <span class="ps-2">Reports</span>
                </RouterLink>
            </li>
            <li class="nav-item">
                <RouterLink class="nav-link d-flex" to="/branches">
                    ...
                    <span class="ps-2">View Branches</span>
                </RouterLink>
            </li>
            <li class="nav-item">
                <RouterLink class="nav-link d-flex" to="/cheques">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-book-open"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path></svg>
                    <span class="ps-2">Cheques</span>
                </RouterLink>
            </li>
            <li class="nav-item">
                <RouterLink class="nav-link d-flex" to="/editcategories">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-archive"><polyline points="21 8 21 21 3 21 3 8"></polyline><rect x="1" y="3" width="22" height="5"></rect><line x1="10" y1="12" x2="14" y2="12"></line></svg>
                    <span class="ps-2">Categories</span>
                </RouterLink>
            </li>
            <li class="nav-item">
                <RouterLink class="nav-link d-flex" to="/a/account">
        ...
        <div class="nav flex-column fs-5 fw-bold position-absolute bottom-0 w-100">
                <RouterLink class="nav-link nav-item d-flex" to="/logout">
