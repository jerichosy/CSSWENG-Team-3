        ...
        submitMonthly() {
            ...
            RecordService.generateMonthlyReport(data)
                .then((response) => {
                    ...
                    link.href = href;
                    link.setAttribute('download', 'Monthly Report.xlsx'); //or any other extension
        ...
        submitQuarterly() {
            ...
            RecordService.generateQuarterlyReport(data)
                .then((response) => {
                    ...
                    const link = document.createElement('a');
                    link.href = href;
                    link.setAttribute('download', 'Quarterly Report.xlsx'); //or any other extension
                    document.body.appendChild(link);
                    link.click();
...
<template>
    <div class="row">
        <h1 class="p-3 m-0">Reports</h1>
        <hr />
    </div>
    <div id="reports-container">
        <form class="mt-5 mb-5" @submit.prevent="submitMonthly">
